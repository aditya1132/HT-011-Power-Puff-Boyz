...
from app.api import chat, mood, coping, users, dashboard
...
async def root():
    ...
    return {
        ...
        "version": "1.0.0",
        "documentation": "/docs" if settings.ENVIRONMENT != "production" else "Contact support for documentation",
        "support": {
            "crisis_hotline": "988",
